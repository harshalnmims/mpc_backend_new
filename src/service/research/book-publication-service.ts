...
export const renderBookPublicationService = async (username:string) => {
...
export const bookPublicationEditViewService = async (bookPublicationId: number, username: string) => {
