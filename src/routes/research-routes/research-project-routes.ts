import { getResearchProjectForm, insertResearchForm, updateResearchForm, 
    deleteResearchForm, researchProjectRenderData, researchProjectEditViewForm, viewResearchProjectForm,
...
researchProjectRoutes.post('/research-project-insert', upload.array("supporting_documents"), asyncErrorHandler(insertResearchForm));
researchProjectRoutes.get('/research-project-edit-view-form', asyncErrorHandler(researchProjectEditViewForm));

researchProjectRoutes.post('/research-project-update', upload.array("supporting_documents"),asyncErrorHandler(updateResearchForm));
